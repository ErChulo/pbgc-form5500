...
## Active Technologies
- JavaScript in browser plus Node.js 24 for build/test + `pdf.js` display layer for PDF parsing and rendering; no backend services (003-full-5500-extraction)
...
- JavaScript for modern browsers; Node.js 24 for build and tests + `pdfjs-dist` for PDF text extraction/rendering; built-in browser APIs and Node built-ins (006-full-filing-extraction)
- In-memory browser state only; exported files only on explicit user action (006-full-filing-extraction)
...
## Recent Changes
- 006-full-filing-extraction: Added JavaScript for modern browsers; Node.js 24 for build and tests + `pdfjs-dist` for PDF text extraction/rendering; built-in browser APIs and Node built-ins
...
- 003-full-5500-extraction: Added JavaScript in browser plus Node.js 24 for build/test + `pdf.js` display layer for PDF parsing and rendering; no backend services
